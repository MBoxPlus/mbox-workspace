...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "git@github.com:MBoxPlus/#{underscore_package_name.gsub('_', '-')}.git", :tag => "#{spec.version}" }
  spec.platform     = :osx, '10.15'

  spec.source_files = "MBWorkspaceLoader/*.{h,m,swift}", "MBWorkspaceLoader/**/*.{h,m,swift}"
