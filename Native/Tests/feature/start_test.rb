...
class FeatureStart < MBoxWorkspaceTests
  ...
  def setup_feature(name)
    ...
    assert_repo(name, ["AFNetworking", "git@github.com:AFNetworking/AFNetworking.git", "[feature/#{name}]", "->", "[master]"])
  end
  ...
  def test_start_a_new_feature_from_free_with_repos_and_changes
    ...
    assert_repo("newFeature", ["AFNetworking", "git@github.com:AFNetworking/AFNetworking.git", "[feature/newFeature]", "->", "[master]"])
    assert_not_contains_file(@tests_dir + "/AFNetworking", "CHANGELOG.md")
  end
  ...
  def test_switch_a_exist_feature_from_free
    ...
    assert_repo("feature1", ["AFNetworking", "git@github.com:AFNetworking/AFNetworking.git", "[feature/feature1]", "->", "[master]"])
    assert_not_contains_file(@tests_dir + "/AFNetworking", "CHANGELOG.md")
  end
